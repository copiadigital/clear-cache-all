    ...
    public function register()
    {
        function clear_cache_after_save_post( $post_id ) {
            if (function_exists('shell_exec')) {
                ...
                if ( defined( 'W3TC' ) ) {
                    shell_exec('php ' . __DIR__ . '/../../wp-cli.phar w3-total-cache flush all --allow-root');
                }
                // clear view blade cache
                if (function_exists('view')) {
                    shell_exec('php ' . __DIR__ . '/../../wp-cli.phar acorn view:clear --allow-root');
                }
                // clear wordpress cache
                shell_exec('php ' . __DIR__ . '/../../wp-cli.phar cache flush --allow-root');
            }
        }
